...
function App() {
    ...
    // Stop words to exclude from search if needed, but simple includes check is usually fine for this scale
    // const STOP_WORDS = ['the', 'and', 'a', 'an', 'in', 'on', 'at', 'to', 'for', 'of', 'with', 'by'];
